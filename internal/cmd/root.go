...
func Execute(args []string) error {
	...
	root := &cobra.Command{
		Use:           "gog",
		Short:         "Google CLI for Gmail/Calendar/Drive/Contacts/Tasks/Keep",
		SilenceUsage:  true,
		SilenceErrors: true,
...
`),
	...
	root.PersistentFlags().StringVar(&flags.Account, "account", "", "Account email for API commands (gmail/calendar/drive/contacts/tasks/keep)")
	...
	root.AddCommand(newKeepCmd(&flags))
